		  ...
		  <ul class="pagination">
		    ...
		    <?php 
		    	...
		    	for ($i=1; $i <= $this->steps; $i++) { 
		    		...
		    		$prev_page = $page_number - $x;
		    		if (is_numeric($page_number) && is_numeric($prev_page)) {
			    		echo '
			    		<li class="page-item">
					    	<a class="page-link" href="'.$this->create_page_link($prev_page).'">'.$prev_page.'</a>
					    </li>';
				    }
				    $x--;
		    	}
		    ...
		    <?php 
		    	for ($i=1; $i <= $this->steps; $i++) { 
		    		$next_page = $page_number + $i;
		    		if (is_numeric($page_number) && is_numeric($next_page)) {
			    		echo '
			    		<li class="page-item">
					    	<a class="page-link" href="'.$this->create_page_link($next_page).'">'.$next_page.'</a>
					    </li>';
				    }
		    	}
		    ?>
